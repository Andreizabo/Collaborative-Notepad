...
![Threads and Communication](Diagram 6.png){#threads}
...
![Other commands that can be issued by the
Client](Diagram 5.png){#ComSeC2}
...
![UI - Session list](1.png){#UISL}

![UI - Session list](3.png){#UISL}

![UI - Editor and Options](2.png){#UIEO}
